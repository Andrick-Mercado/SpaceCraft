...
{
    //link to the tutorial https://www.jonathanyu.xyz/2016/07/08/a-simple-dialog-quest-system-for-unity/
    ...
    public void StartQuest(string questFilePath)
    {
        ...
        _questDialog.GetComponent().Initialize(Quest.LoadQuest(questFilePath));      //Uses the Dialog UI and initializes the quest onto the display
    }
